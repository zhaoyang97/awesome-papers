...
|------|----------|----------|--------|
| Era 1 · Foundations | 1957-2011 | Perceptron / Backprop / SVM / LSTM / LeNet / ImageNet | 16 |
| Era 2 · Deep Renaissance | 2012-2016 | AlexNet / Word2Vec / GAN / Attention / ResNet / AlphaGo | 31 |
| Era 3 · Attention Era | 2017-2019 | Transformer / AlphaZero / BERT / GPT / PPO / Mask R-CNN | 24 |
...
- **2013** · [ZFNet — Visualizing the Black Box That AlexNet Opened](docs_en/era2_deep_renaissance/2013_zfnet.md)
...
- **2014** · [GloVe - The Global Co-occurrence Bridge for Word Vectors](docs_en/era2_deep_renaissance/2014_glove.md)
- **2014** · [Network In Network — Putting a Tiny MLP Inside Every Convolution](docs_en/era2_deep_renaissance/2014_network_in_network.md)
...
- **2015** · [Spatial Transformer Networks — Letting CNNs Learn to Crop, Align, and Warp](docs_en/era2_deep_renaissance/2015_spatial_transformer.md)
...
- **2016** · [A3C - Asynchronous Actors as the Stabilizer for Deep Reinforcement Learning](docs_en/era2_deep_renaissance/2016_a3c.md)
- **2016** · [AlphaGo — Defeating the Human Go World Champion with MCTS + Deep Networks](docs_en/era2_deep_renaissance/2016_alphago.md)
- **2016** · [DenseNet - Feature Reuse as a Network Architecture](docs_en/era2_deep_renaissance/2016_densenet.md)
- **2016** · [LayerNorm: Normalization Without a Batch](docs_en/era2_deep_renaissance/2016_layer_norm.md)
- **2016** · [WaveNet - The Neural Starting Point for Raw-Waveform Generation](docs_en/era2_deep_renaissance/2016_wavenet.md)
...
- **2017** · [Capsule Networks — Routing Parts into Wholes](docs_en/era3_attention/2017_capsule_networks.md)
...
- **2017** · [WGAN — Curing GAN Training Instability with Wasserstein Distance](docs_en/era3_attention/2017_wgan.md)
...
- **2018** · [ULMFiT — Making Language Model Fine-tuning Work](docs_en/era3_attention/2018_ulmfit.md)
...
- **2019** · [Sentence-BERT — Turning BERT into a Sentence Embedding Engine](docs_en/era3_attention/2019_sentence_bert.md)
...
- **2020** · [MuZero — Planning in Unknown Worlds with a Learned Model](docs_en/era4_foundation_models/2020_muzero.md)
- **2020** · [NeRF — Encoding a Scene into a Differentiable Radiance Field with One MLP](docs_en/era4_foundation_models/2020_nerf.md)
- **2020** · [Reformer — LSH and Reversible Layers for Million-Token Transformers](docs_en/era4_foundation_models/2020_reformer.md)
...
- **2022** · [ConvNeXt — Porting Every Swin Trick Back into a Pure ConvNet and Finding the CNN Decade Was Underrated](docs_en/era4_foundation_models/2022_convnext.md)
- **2022** · [DALL-E 2 - Rewriting Text-to-Image as CLIP-Latent Imagination plus Diffusion Rendering](docs_en/era4_foundation_models/2022_dalle2.md)
...
- **2022** · [DreamFusion — Text-to-3D by Distilling a Frozen 2D Diffusion into a NeRF](docs_en/era4_foundation_models/2022_dreamfusion.md)
...
- **2023** · [RWKV - Reinventing RNNs for the Transformer Era](docs_en/era5_genai_explosion/2023_rwkv.md)
...
- **2024** · [Mamba-2 - When Transformers and SSMs Meet in the Same Algebra](docs_en/era5_genai_explosion/2024_mamba2.md)
- **2024** · [OpenAI o1 - Reinforcement Learning for Deep LLM Reasoning](docs_en/era5_genai_explosion/2024_o1.md)
...
│   ├── index.md
│   ├── era1_foundations/               # 16 notes — 1957-2011 Foundations
...
│   ├── era2_deep_renaissance/          # 31 notes — 2012-2016 Deep Renaissance
...
│   ├── era3_attention/                 # 24 notes — 2017-2019 Attention Era
...
│   ├── era4_foundation_models/         # 35 notes — 2020-2022 Foundation Models
...
│   ├── era5_genai_explosion/           # 28 notes — 2023-present Large Model Era
