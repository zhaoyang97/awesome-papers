...
| 时代 | 时间范围 | 主题代表 | 收录数 |
|------|----------|----------|--------|
| Era 1 · 神经网络萌芽 | 1957-2011 | Perceptron / Backprop / SVM / LSTM / LeNet / ImageNet | 14 |
...
- **2025** · [GPT-5：当模型选择变成系统能力](docs_zh/era5_genai_explosion/2025_gpt5.md)
- **2025** · [Gemini 2.5 - 当思考、多模态、长上下文与工具调用汇成一个模型族](docs_zh/era5_genai_explosion/2025_gemini25.md)
- **2025** · [Gemma 3 - 把多模态长上下文压进单张加速卡的开放权重模型族](docs_zh/era5_genai_explosion/2025_gemma3.md)
- **2025** · [Kimi K2 家族：从开放智能体到 3T 级前沿模型](docs_zh/era5_genai_explosion/2025_kimi_k2.md)
- **2025** · [Llama 4 - 原生多模态、稀疏专家与十百万上下文的开放权重实验](docs_zh/era5_genai_explosion/2025_llama4.md)
- **2025** · [Qwen2.5 / Qwen3 - 阿里通义千问如何把开放模型做成全栈模型族](docs_zh/era5_genai_explosion/2025_qwen3.md)
- **2024** · [AlphaFold 3 — 用全原子扩散统一预测生物分子复合物](docs_zh/era5_genai_explosion/2024_alphafold3.md)
- **2024** · [DeepSeek-V2 / V3 - MLA 与 MoE 如何把开源模型推到前沿](docs_zh/era5_genai_explosion/2024_deepseek_v3.md)
- **2024** · [GPT-4o：从三段式语音管线到 320 毫秒原生交互](docs_zh/era5_genai_explosion/2024_gpt4o.md)
...
- **2024** · [OpenAI o1 -> o3/o4-mini - 推理模型从 test-time compute 走向 agent](docs_zh/era5_genai_explosion/2024_o1.md)
- **2024** · [Phi-4：把数据质量变成小模型推理能力的训练系统](docs_zh/era5_genai_explosion/2024_phi4.md)
- **2024** · [SWE-bench + SWE-agent — 当写代码从函数题变成真实仓库](docs_zh/era5_genai_explosion/2024_swe_bench.md)
...
- **2023** · [Diffusion Policy: Visuomotor Policy Learning via Action Diffusion](docs_zh/era5_genai_explosion/2023_diffusion_policy.md)
...
- **2022** · [DiT - 当扩散模型把 U-Net 换成 Transformer](docs_zh/era4_foundation_models/2022_dit.md)
...
- **2022** · [FlashAttention：不减少一次注意力计算，为什么反而更快](docs_zh/era4_foundation_models/2022_flashattention.md)
...
- **2020** · [RAG — 把维基百科变成生成模型的可替换记忆](docs_zh/era4_foundation_models/2020_rag.md)
...
│   ├── index.md
│   ├── era1_foundations/               # 14 notes — 1957-2011 神经网络萌芽
...
│   ├── era2_deep_renaissance/          # 24 notes — 2012-2016 深度学习复兴
