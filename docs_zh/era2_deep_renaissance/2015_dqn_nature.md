...
- 建议连读：[DQN 2013](2013_dqn.md) 看 workshop 原型，[AlexNet](2012_alexnet.md) 看 CNN-on-pixels 信心来源，[AlphaGo](2016_alphago.md) 看深度价值函数如何进入搜索，Rainbow 看 DQN 系修补，[MuZero](../era4_foundation_models/2020_muzero.md) 看无规则模型的规划路线。
