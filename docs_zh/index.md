...
## Era 5 · 大模型时代 (2023-present) <small>28 篇</small>
...
- **2024** · [Mamba-2 - Transformer 与 SSM 原来共享同一套代数](era5_genai_explosion/2024_mamba2.md)
...
- **2023** · [RWKV - 把 RNN 重新带回 Transformer 时代的线性大模型](era5_genai_explosion/2023_rwkv.md)
...
## Era 4 · 基础模型 (2020-2022) <small>35 篇</small>
...
- **2022** · [ConvNeXt — 把 Swin 的所有 trick 搬回纯卷积，发现 CNN 一直都没有输](era4_foundation_models/2022_convnext.md)
- **2022** · [DALL-E 2 - 用 CLIP 潜空间把文生图改写成先想象再渲染](era4_foundation_models/2022_dalle2.md)
- **2022** · [DreamBooth — 用 3-5 张照片把任意主体「植入」文生图模型](era4_foundation_models/2022_dreambooth.md)
- **2022** · [DreamFusion — 用 2D 扩散先验把 NeRF 优化成文生 3D](era4_foundation_models/2022_dreamfusion.md)
...
- **2020** · [MuZero — 在不知道规则的世界里用学来的模型规划](era4_foundation_models/2020_muzero.md)
- **2020** · [NeRF — 用一个 MLP 把场景编码成可微分的辐射场](era4_foundation_models/2020_nerf.md)
- **2020** · [Reformer — 用 LSH 和可逆层把 Transformer 推向百万级上下文](era4_foundation_models/2020_reformer.md)
...
## Era 3 · 注意力机制 (2017-2019) <small>24 篇</small>
...
- **2019** · [Sentence-BERT — 把 BERT 变成可检索的句向量引擎](era3_attention/2019_sentence_bert.md)
...
- **2018** · [ULMFiT — 让 NLP 预训练微调真正可用](era3_attention/2018_ulmfit.md)
- **2017** · [AlphaZero — 用纯自对弈把人类围棋知识从 RL 中彻底删除](era3_attention/2017_alphazero.md)
- **2017** · [Capsule Networks — 用动态路由替换池化的视觉旧梦](era3_attention/2017_capsule_networks.md)
...
- **2017** · [WGAN — 用 Wasserstein 距离根治 GAN 训练不稳定](era3_attention/2017_wgan.md)

## Era 2 · 深度学习复兴 (2012-2016) <small>31 篇</small>

- **2016** · [A3C - 用异步 actor 把深度强化学习从 replay 里解放出来](era2_deep_renaissance/2016_a3c.md)
- **2016** · [AlphaGo — 用蒙特卡洛树搜索 + 深度网络打败人类围棋世界冠军](era2_deep_renaissance/2016_alphago.md)
- **2016** · [DenseNet - 把每一层的特征都留给后来者](era2_deep_renaissance/2016_densenet.md)
- **2016** · [LayerNorm: 把归一化从 batch 搬到样本内部](era2_deep_renaissance/2016_layer_norm.md)
- **2016** · [WaveNet - 直接生成原始波形的神经声码器起点](era2_deep_renaissance/2016_wavenet.md)
...
- **2015** · [Spatial Transformer Networks — 让 CNN 学会主动裁剪、对齐和变形](era2_deep_renaissance/2015_spatial_transformer.md)
...
- **2014** · [GloVe - 把全局共现统计压成词向量的最后一块拼图](era2_deep_renaissance/2014_glove.md)
- **2014** · [Network In Network — 把小 MLP 塞进每个卷积窗口](era2_deep_renaissance/2014_network_in_network.md)
...
- **2013** · [ZFNet — 用反卷积把 CNN 黑箱拆开](era2_deep_renaissance/2013_zfnet.md)
...
## Era 1 · 神经网络萌芽 (1957-2011) <small>16 篇</small>

- **2011** · [Deep Sparse Rectifier Neural Networks](era1_foundations/2011_relu.md)
- **2010** · [RNN-LM - 把语言模型从固定窗口带进连续隐状态](era1_foundations/2010_rnnlm.md)
- **2010** · [Stacked Denoising Autoencoders — 用局部去噪准则把自编码器变成深度预训练工具](era1_foundations/2010_stacked_dae.md)
- **2010** · [Understanding the difficulty of training deep feedforward neural networks](era1_foundations/2010_glorot_init.md)
- **2009** · [ImageNet — 用 1500 万张图把「数据集」变成深度学习革命的引信](era1_foundations/2009_imagenet.md)
- **2008** · [Visualizing Data using t-SNE](era1_foundations/2008_tsne.md)
- **2006** · [DBN — 用逐层贪婪预训练让深层神经网络第一次「被训得动」](era1_foundations/2006_dbn.md)
- **2006** · [Reducing the Dimensionality of Data with Neural Networks](era1_foundations/2006_autoencoder.md)
- **2003** · [Latent Dirichlet Allocation](era1_foundations/2003_lda.md)
